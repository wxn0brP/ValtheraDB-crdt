...
export type CrdtOperation<T = any> = AddOperation<T> | MutationOp | CompactOp<T>;
...
export interface ValtheraCRDT_Proxy {
    ...
    sync: (other: ValtheraCompatible & ValtheraCRDT_Proxy, collection: string, options?: boolean | SyncOpts) => Promise<SyncResult>;
